        ...
        <div class="col-lg-10">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- Vertical Form -->
              <form method="POST" action="{{route("update.animal", $result->id)}}" enctype="multipart/form-data">
                @csrf

                <div class="col-12">
                    <label for="inputNumber" class="col-sm-2 col-form-label"> Image</label>
                    
                      <input class="form-control"  name="animal_image" id="image" type="file"  >
                      @error('animal_image')
                ...
                <div class="form-group">
                    <img id="showImage"  src="{{asset($result->animal_image)}}" alt="" style="width: 100px; height:100px">
                ...
                <div class="col-12">
                  ...
                  <div class="col-12">
                    <label for="inputNumber" class="col-sm-2 col-form-label"> Image 2</label>
                      ...
                      <input class="form-control"  name="animal_image2" id="image1" type="file" >
                      @error('animal_image2')
                      <span class="text-danger">{{$message}}</span>
                       @enderror
                </div>
                ...
                <div class="form-group">
                    <img id="showImage1"  src="{{asset($result->animal_image2)}}" alt="" style="width: 100px; height:100px">
                </div>
                <div class="col-12">

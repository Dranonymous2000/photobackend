    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Edit Architecture</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="col-lg-10">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- Vertical Form -->
              <form method="POST" action="{{route("update.architecture", $result->id)}}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    <img id="showImage"  src="{{asset($result->architecture_image)}}" alt="" style="width: 100px; height:100px">
                </div>
                ...
                <div class="form-group">
                    <img id="showImage1"  src="{{asset($result->architecture_image2)}}" alt="" style="width: 100px; height:100px">
                </div>
                <div class="col-12">

        ...
        <div class="col-lg-8">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- Vertical Form -->
              <form method="POST" action="{{route("update.about",$result->id)}}" enctype="multipart/form-data">
                @csrf
                <div class="col-12">
                  <label for="inputNanme4" class="form-label">About Title</label>
                  <input type="text" class="form-control" name="about_title" value="{{$result->about_title}}">
                  @error('about_title')
                ...
                <div class="col-12">
                    ...
                    <textarea class="form-control" name="about_description" >{{$result->about_title}}</textarea>
                ...
                <div class="col-12">
                  ...
                  <input type="text" class="form-control" name="about_intro" value="{{$result->about_intro}}" >
                  @error('about_intro')
                  <span class="text-danger">{{$message}}</span>
                   @enderror
                ...
                <div class="form-group">
                    <img id="showImage"  src="{{asset($result->about_image)}}" alt="" style="width: 100px; height:100px">
                </div>
                <div class="col-12">
                    <label for="inputEmail4" class="form-label">Birthday</label>
                    <input type="text" class="form-control" name="birthday"value="{{$result->birthday}}" >
                    @error('birthday')
                    <span class="text-danger">{{$message}}</span>
                     @enderror
                  </div>
                  <div class="col-12">
                    ...
                    <input type="text" class="form-control" name="age"value="{{$result->age}}" >
                    @error('age')
                    <span class="text-danger">{{$message}}</span>
                     @enderror
                  </div>
                  ...
                  <div class="col-12">
                    ...
                    <input type="text" class="form-control" name="degree"value="{{$result->degree}}" >
                    @error('degree')
                    <span class="text-danger">{{$message}}</span>
                     @enderror
                  </div>
                  ...
                  <div class="col-12">
                    ...
                    <input type="text" class="form-control" name="freelance" value="{{$result->freelance}}" >
                    @error('freelance')
                    <span class="text-danger">{{$message}}</span>
                     @enderror
                  </div>
                  ...
                  <div class="col-12">
                    ...
                    <textarea class="form-control" name="about_longdescription" id="about_longdescription">{{$result->about_longdescription}}</textarea>

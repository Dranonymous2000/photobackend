        ...
        <div class="col-lg-10">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- Vertical Form -->
              <form method="POST" action="{{route("update.review", $result->id)}}" enctype="multipart/form-data">
                @csrf

             
                <div class="col-12">
                  <label for="inputNanme4" class="form-label">Client Name </label>
                  <input type="text" class="form-control" name="client_name" value="{{$result->client_name}}">
                  @error('client_name')
                ...
                <div class="col-12">
                    ...
                    <textarea class="form-control" name="client_description" >{{$result->client_name}}</textarea>
                ...
                <div class="form-group">
                    <img id="showImage1"  src="{{asset($result->client_image)}}" alt="" style="width: 100px; height:100px">
                </div>

            ...
            <div class="card-body">
              ...
              <form method="POST" action="{{route('store.service')}}">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input type="text"  name="service_type1" class="form-control" >
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input type="text"  name="service_type2" class="form-control" >
                    @error('service_type2')
                    <span class="text-danger">{{$message}}</span>
                    @enderror
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input type="text"  name="service_type3" class="form-control" >
                    @error('service_type3')
                    <span class="text-danger">{{$message}}</span>
                    @enderror
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input type="text"  name="service_type4" class="form-control" >
                    @error('service_type4')
                    <span class="text-danger">{{$message}}</span>
                    @enderror
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input type="text"  name="service_type1_desc" class="form-control" >
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input type="text"  name="service_type2_desc" class="form-control" >
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input type="text"  name="service_type3_desc" class="form-control" >
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input type="text"  name="service_type4_desc" class="form-control" >
